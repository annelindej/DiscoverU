function openCity(evt, cityName) {
  ...
  function calculate_type1(score){
...
function get_max_score(score){
  ...
  function calculate_score() {
      if (count_tokens("3") > 4){
        ...
        type1 = data[0][get_max_score(score)+3];
        type2 = data[0][get_max_score(score)+3];
        type3 = data[0][get_max_score(score)+3];
        document.getElementById("type").innerHTML = "Jouw score is: " + type1 + ", " + type2 + ", " + type3; 
